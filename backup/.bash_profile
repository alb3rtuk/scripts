...
### NIMZO ########€€##########
alias nimzo-chown='~/Repos/Nimzo-Ruby/scripts/nimzo/nimzo-chown.sh'
alias nimzo-compile-less='~/Repos/Nimzo-Ruby/scripts/nimzo/nimzo-compile-less.sh'
alias nimzo-create='~/Repos/Nimzo-Ruby/scripts/nimzo/nimzo-create.sh'
alias nimzo-cron-manager='~/Repos/Nimzo-Ruby/scripts/nimzo/nimzo-cron-manager.sh'
alias nimzo-delete='~/Repos/Nimzo-Ruby/scripts/nimzo/nimzo-remove.sh'
alias nimzo-deploy-ebay='~/Repos/Nimzo-Ruby/scripts/nimzo/nimzo-deploy-ebay.sh'
alias nimzo-generate-test='~/Repos/Nimzo-Ruby/scripts/nimzo/nimzo-generate-test.sh'
alias nimzo-remove='~/Repos/Nimzo-Ruby/scripts/nimzo/nimzo-remove.sh'
alias nimzo-rewrite='~/Repos/Nimzo-Ruby/scripts/nimzo/nimzo-rewrite.sh'
alias nimzo-run-tests='~/Repos/Nimzo-Ruby/scripts/nimzo/nimzo-run-tests.sh'
alias nimzo-run-tests-php='~/Repos/Nimzo-Ruby/scripts/nimzo/nimzo-run-tests-php.sh'
alias nimzo-run-tests-php-debug='~/Repos/Nimzo-Ruby/scripts/nimzo/nimzo-run-tests-php-debug.sh'
alias nimzo-run-tests-php-isolated='~/Repos/Nimzo-Ruby/scripts/nimzo/nimzo-run-tests-php-isolated.sh'
alias nimzo-run-tests-ruby='~/Repos/Nimzo-Ruby/scripts/nimzo/nimzo-run-tests-ruby.sh'
alias nimzo-show-groups='~/Repos/Nimzo-Ruby/scripts/nimzo/nimzo-show-groups.sh'
alias nimzo-show-routes='~/Repos/Nimzo-Ruby/scripts/nimzo/nimzo-show-routes.sh'
alias nimzo-tail-logs='~/Repos/Nimzo-Ruby/scripts/nimzo/nimzo-tail-logs.sh'
alias nimzo-update='~/Repos/Nimzo-Ruby/scripts/nimzo/nimzo-update.sh'
alias nimzo-update-sleek='~/Repos/Nimzo-Ruby/scripts/nimzo/nimzo-update-sleek.sh'
alias nimzo-watcher='~/Repos/Nimzo-Ruby/scripts/nimzo/nimzo-watcher.sh'

### NIMZO (SHORT) ############
alias ncl='~/Repos/Nimzo-Ruby/scripts/nimzo/nimzo-compile-less.sh'
alias nc='~/Repos/Nimzo-Ruby/scripts/nimzo/nimzo-create.sh'
alias ngt='~/Repos/Nimzo-Ruby/scripts/nimzo/nimzo-generate-test.sh'
alias nd='~/Repos/Nimzo-Ruby/scripts/nimzo/nimzo-remove.sh'
alias nr='~/Repos/Nimzo-Ruby/scripts/nimzo/nimzo-remove.sh'
alias nt='~/Repos/Nimzo-Ruby/scripts/nimzo/nimzo-run-tests.sh'
alias ntp='~/Repos/Nimzo-Ruby/scripts/nimzo/nimzo-run-tests-php.sh'
alias ntpd='~/Repos/Nimzo-Ruby/scripts/nimzo/nimzo-run-tests-php-debug.sh'
alias ntpi='~/Repos/Nimzo-Ruby/scripts/nimzo/nimzo-run-tests-php-isolated.sh'
alias ntr='~/Repos/Nimzo-Ruby/scripts/nimzo/nimzo-run-tests-ruby.sh'
alias nsg='~/Repos/Nimzo-Ruby/scripts/nimzo/nimzo-show-groups.sh'
alias nsr='~/Repos/Nimzo-Ruby/scripts/nimzo/nimzo-show-routes.sh'
alias ntl='~/Repos/Nimzo-Ruby/scripts/nimzo/nimzo-tail-logs.sh'
alias nu='~/Repos/Nimzo-Ruby/scripts/nimzo/nimzo-update.sh'
alias nus='~/Repos/Nimzo-Ruby/scripts/nimzo/nimzo-update-sleek.sh'
alias nw='~/Repos/Nimzo-Ruby/scripts/nimzo/nimzo-watcher.sh'
