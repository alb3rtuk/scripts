...
### NIMZO ##################
alias ncm='~/Repos/Scripts/bash/nimzo/nimzo-create-modal.sh'
alias nimzo-create-modal='~/Repos/Scripts/bash/nimzo/nimzo-create-modal.sh'
alias nco='~/Repos/Scripts/bash/nimzo/nimzo-create-overlay.sh'
alias nimzo-create-overlay='~/Repos/Scripts/bash/nimzo/nimzo-create-overlay.sh'
alias ncp='~/Repos/Scripts/bash/nimzo/nimzo-create-page.sh'
alias nimzo-create-page='~/Repos/Scripts/bash/nimzo/nimzo-create-page.sh'
alias ncs='~/Repos/Scripts/bash/nimzo/nimzo-create-system.sh'
alias nimzo-create-system='~/Repos/Scripts/bash/nimzo/nimzo-create-system.sh'
alias ncw='~/Repos/Scripts/bash/nimzo/nimzo-create-widget.sh'
alias nimzo-create-widget='~/Repos/Scripts/bash/nimzo/nimzo-create-widget.sh'
alias nrm='~/Repos/Scripts/bash/nimzo/nimzo-remove-modal.sh'
alias nimzo-remove-modal='~/Repos/Scripts/bash/nimzo/nimzo-remove-modal.sh'
alias nro='~/Repos/Scripts/bash/nimzo/nimzo-delete-overlay.sh'
alias nimzo-remove-overlay='~/Repos/Scripts/bash/nimzo/nimzo-remove-overlay.sh'
alias nrp='~/Repos/Scripts/bash/nimzo/nimzo-remove-page.sh'
alias nimzo-remove-page='~/Repos/Scripts/bash/nimzo/nimzo-remove-page.sh'
alias nrs='~/Repos/Scripts/bash/nimzo/nimzo-remove-system.sh'
alias nimzo-remove-system='~/Repos/Scripts/bash/nimzo/nimzo-remove-system.sh'
alias nrw='~/Repos/Scripts/bash/nimzo/nimzo-remove-widget.sh'
alias nimzo-remove-widget='~/Repos/Scripts/bash/nimzo/nimzo-remove-widget.sh'
alias nrt='~/Repos/Scripts/bash/nimzo/nimzo-run-tests.sh'
alias nimzo-run-tests='~/Repos/Scripts/bash/nimzo/nimzo-run-tests.sh'
alias nrti='~/Repos/Scripts/bash/nimzo/nimzo-run-tests-isolated.sh'
alias nimzo-run-tests-isolated='~/Repos/Scripts/bash/nimzo/nimzo-run-tests-isolated.sh'
alias nrtsg='~/Repos/Scripts/bash/nimzo/nimzo-run-tests-show-groups.sh'
