...
alias nimzo-generate-test='~/Repos/Scripts/bash/nimzo/nimzo-generate-test.sh'
...
alias nimzo-run-tests-php='~/Repos/Scripts/bash/nimzo/nimzo-run-tests-php.sh'
alias nimzo-run-tests-php-debug='~/Repos/Scripts/bash/nimzo/nimzo-run-tests-php-debug.sh'
alias nimzo-run-tests-php-isolated='~/Repos/Scripts/bash/nimzo/nimzo-run-tests-php-isolated.sh'
alias nimzo-run-tests-ruby='~/Repos/Scripts/bash/nimzo/nimzo-run-tests-ruby.sh'
alias nimzo-show-groups='~/Repos/Scripts/bash/nimzo/nimzo-show-groups.sh'
alias nimzo-show-routes='~/Repos/Scripts/bash/nimzo/nimzo-show-routes.sh'
alias nimzo-tail-logs='~/Repos/Scripts/bash/nimzo/nimzo-tail-logs.sh'
...
alias ngt='~/Repos/Scripts/bash/nimzo/nimzo-generate-test.sh'
...
alias ntp='~/Repos/Scripts/bash/nimzo/nimzo-run-tests-php.sh'
alias ntpd='~/Repos/Scripts/bash/nimzo/nimzo-run-tests-php-debug.sh'
alias ntpi='~/Repos/Scripts/bash/nimzo/nimzo-run-tests-php-isolated.sh'
alias ntr='~/Repos/Scripts/bash/nimzo/nimzo-run-tests-ruby.sh'
alias nsg='~/Repos/Scripts/bash/nimzo/nimzo-show-groups.sh'
alias nsr='~/Repos/Scripts/bash/nimzo/nimzo-show-routes.sh'
alias ntl='~/Repos/Scripts/bash/nimzo/nimzo-tail-logs.sh'
