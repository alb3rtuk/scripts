...
alias nimzo-run-php-tests='~/Repos/Scripts/bash/nimzo/nimzo-run-php-tests.sh'
alias nimzo-run-php-tests-debug='~/Repos/Scripts/bash/nimzo/nimzo-run-php-tests-debug.sh'
alias nimzo-run-php-tests-isolated='~/Repos/Scripts/bash/nimzo/nimzo-run-php-tests-isolated.sh'
alias nimzo-run-ruby-tests='~/Repos/Scripts/bash/nimzo/nimzo-run-ruby-tests.sh'
...
alias nt='~/Repos/Scripts/bash/nimzo/nimzo-run-php-tests.sh'
alias ntp='~/Repos/Scripts/bash/nimzo/nimzo-run-php-tests.sh'
alias ntpd='~/Repos/Scripts/bash/nimzo/nimzo-run-php-tests-debug.sh'
alias ntpi='~/Repos/Scripts/bash/nimzo/nimzo-run-php-tests-isolated.sh'
alias ntr='~/Repos/Scripts/bash/nimzo/nimzo-run-ruby-tests.sh'
