...
alias ndm='~/Repos/Scripts/bash/nimzo/nimzo-delete-modal.sh'
alias nimzo-delete-modal='~/Repos/Scripts/bash/nimzo/nimzo-delete-modal.sh'
alias ndo='~/Repos/Scripts/bash/nimzo/nimzo-delete-overlay.sh'
alias nimzo-delete-overlay='~/Repos/Scripts/bash/nimzo/nimzo-delete-overlay.sh'
alias ndp='~/Repos/Scripts/bash/nimzo/nimzo-delete-page.sh'
alias nimzo-delete-page='~/Repos/Scripts/bash/nimzo/nimzo-delete-page.sh'
alias nds='~/Repos/Scripts/bash/nimzo/nimzo-delete-system.sh'
alias nimzo-delete-system='~/Repos/Scripts/bash/nimzo/nimzo-delete-system.sh'
alias ndw='~/Repos/Scripts/bash/nimzo/nimzo-delete-widget.sh'
