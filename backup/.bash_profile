...
alias nimzo-page-create-legacy='~/Repos/Scripts/bash/nimzo/nimzo-page-create-legacy.sh'
alias nimzo-page-create-legacy='~/Repos/Scripts/bash/nimzo/nimzo-page-create-legacy.sh'

### NIMZO ##################
alias nimzo-modal-create='~/Repos/Scripts/bash/nimzo/nimzo-modal-create.sh'
alias nimzo-overlay-create='~/Repos/Scripts/bash/nimzo/nimzo-overlay-create.sh'
alias nimzo-page-create='~/Repos/Scripts/bash/nimzo/nimzo-page-create.sh'
alias nimzo-system-create='~/Repos/Scripts/bash/nimzo/nimzo-system-create.sh'
alias nimzo-widget-create='~/Repos/Scripts/bash/nimzo/nimzo-widget-create.sh'
alias nimzo-modal-delete='~/Repos/Scripts/bash/nimzo/nimzo-modal-delete.sh'
alias nimzo-overlay-delete='~/Repos/Scripts/bash/nimzo/nimzo-overlay-delete.sh'
alias nimzo-page-delete='~/Repos/Scripts/bash/nimzo/nimzo-page-delete.sh'
alias nimzo-system-delete='~/Repos/Scripts/bash/nimzo/nimzo-system-delete.sh'
alias nimzo-widget-delete='~/Repos/Scripts/bash/nimzo/nimzo-widget-delete.sh'
