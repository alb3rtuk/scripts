...
class ShowBankTransactions
    ...
    def initialize(argv)
        ...
        @recognizedTransactions = Array[
            ...
            {:intTypeID => 2, :id => 1150, :bank_account_id => 1, :type => 'BAC', :terms => Array['SALARY','T27 SYSTEMS'], :color => 'cyan', :translation => 'BRIGHTPEARL WAGE', :recurring_amount => 900}, # 1946.23
        ...
        # Hawaii Payments
        @ignoredTransactions.push(*Array[2556, 2557, 2558, 2555, 2545, 2567, 2576, 2566, 2959, 3328, 3364, 3310, 3349, 3405, 3413, 3424, 3482, 3483, 3493])
    ...
    def displaySummary
        ...
        table(:border => false) do
            row do
                ...
                column('5-Month Total', :width => @summaryWidth_7, :align => 'right')
    ...
    def recognizedTransactionLoop(intTypeId)
        @recognizedTransactions.each do |recognizedTransaction|
            if recognizedTransaction[:intTypeID] == intTypeId
                ...
                if intTypeId == 2
                    color = Array['cyan', 'cyan', 'cyan', 'cyan', 'cyan', 'white']
                else
