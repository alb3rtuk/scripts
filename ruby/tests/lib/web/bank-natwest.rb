...
class TestBankNatWest < Test::Unit::TestCase
    ...
    def testLogin
        ...
        assert_equal(data[0].frame(:id => f).tr(:id => 'Account_A412AD6062AE989A9FCDAEB7D9ED8A594808AC87').exists?, true)
        assert_equal(data[0].frame(:id => f).tr(:id => 'Account_CE99D6FF6219B59BB28B6A42825D98D60B92326C').exists?, true)
        assert_equal(data[0].frame(:id => f).tr(:id => 'Account_FAB7EFB59260BED0F1081E761570BF4227C37E6B').exists?, true)
